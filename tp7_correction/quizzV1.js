 (function() {
       ...
       _makeBuildList: function() {
        ...
        SlideShow.prototype = {
          ...
          go: function(slideId) {
            ...
            var qid=this._getCurrentIndex()-2;
            var s = this._slides[this._getCurrentIndex()];
            var r = document.getElementById("q"+qid).value;
            console.log(r);
            localStorage.setItem("q"+qid,r);
            
             var s = document.querySelector('.slide:nth-child(' + this._getCurrentIndex() + ') header h1');
            s.innerHTML = "Saved";
            },
   ...
   //     var stylesheetPath = sessionStorage['theme'] || 'css/default.css';
        ...
        if(i>1&&localStorage['q'+(i-1)]) {
           var s = document.querySelector('.slide:nth-child('+(i+1)+') header h1');
