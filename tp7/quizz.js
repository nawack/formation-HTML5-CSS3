 (function() {
        ...
        SlideShow.prototype = {
		  ...
		  unabledReponse: function(id) {
			  var elem = document.getElementsByName("rq" + id);
			  switch (id) {
				case 1: //question 1
		  ...
		  save: function() {
			  var idQuestion = this._getCurrentIndex()-2;
			  var slide = this._slides[this._getCurrentIndex()-1];
			  var reponse = document.getElementsByName("rq" + idQuestion);
			  switch (idQuestion) {
				case 1: //question 1
				  if (reponse[0].checked) {
					reponse = reponse[0].value;
				  } else {
					reponse = reponse[1].value;
				  }
				  break
			  }
			  console.log(reponse);
			  localStorage.setItem("rq" + idQuestion, reponse)
			  
			  this.unabledReponse(idQuestion);
			  
			  var saveDiv = document.querySelector("#savedValue" + idQuestion);
			  saveDiv.innerHTML = "R&eacute;ponse enregistr&eacute;: " + localStorage.getItem("rq" + idQuestion);
		  }
